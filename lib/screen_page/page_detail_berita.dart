        ...
        children: [
          Padding(
            ...
            child: ClipRRect(
              ...
              child: Image.network(
                "http://192.168.37.142/edukasi_server_lat/gambar_berita/${data?.gambar}",
                fit: BoxFit.fill,
              ),
            ),
          ),
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      http.Response response = await http
          .get(Uri.parse("http://192.168.233.142/edukasi_server_lat/getBerita.php"));
                          ...
                          children: [
                            Padding(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(10),
                                child: Image.network(
                                  'http://192.168.233.142/edukasi_server_lat/gambar_berita/${data?.gambar}',
                                  fit: BoxFit.fill,
                                ),
                              ),
                            ),
